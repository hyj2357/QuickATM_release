...
<body>
  ...
  <div class="top">
   ...
   <div style="z-index:4;position:fixed;top:3.5%;width:100%;">
      <a href="http://139.129.24.81:8082/QuickATM/LoginOut">                                    <!--  href -->
...
顶部的退出条图标.
   ...
   <div class="op_border">
      ...
      <div class="op_border_div"   onclick="window.location.href='http://139.129.24.81:8082/QuickATM/pfs_s?p=op.jsp'" style="background-color:#FFFFFF;border-color:#FFFFFF #FF9900 #FFFFFF #FFFFFF;">
	    <span>
	     首页
		</span>
	  </div>
