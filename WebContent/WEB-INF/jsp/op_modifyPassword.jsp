...
<body>
  ...
  <div class="top">
   ...
   <div style="z-index:4;position:fixed;top:3.5%;width:100%;">
      <a href="http://139.129.24.81:10566/QuickATM/LoginOut">
   ...
   <div class="content">
      <div style="left: 25%;position: absolute;top:20%;">
          <form action="http://139.129.24.81:10566/QuickATM/ModifyPassword" method="post">
   ...
   <div class="op_border">
      ...
      <div class="op_border_div"   onclick="window.location.href='http://139.129.24.81:10566/QuickATM/pfs_s?p=op.jsp'" onmouseout="cgOpBorderDivMouseOut($(this))" onmousemove="cgOpBorderDivMouseOver($(this))">
	    <span>
	     首页
		</span>
	  </div>
      <div class="op_border_div"  onclick="window.location.href='http://139.129.24.81:10566/QuickATM/pfs_s?p=op_deposit.jsp'" onclick="window.location.href='op_modifyPassword.htm'"  onmouseout="cgOpBorderDivMouseOut($(this))" onmousemove="cgOpBorderDivMouseOver($(this))">
	    <span>
	     存款
		</span>
	  </div>
      <div class="op_border_div"  onclick="window.location.href='http://139.129.24.81:10566/QuickATM/pfs_s?p=op_draw.jsp'"  onmouseout="cgOpBorderDivMouseOut($(this))" onmousemove="cgOpBorderDivMouseOver($(this))">
	    <span>
	     取款
		</span>
	  </div>
      ...
      <div class="op_border_div"  onclick="window.location.href='http://139.129.24.81:10566/QuickATM/pfs_s?p=op_modifyPassword.jsp'" style="background-color:#FFFFFF;border-color:#FFFFFF #FF9900 #FFFFFF #FFFFFF;">
	    <span>
	     修改密码
		</span>
	  </div>
