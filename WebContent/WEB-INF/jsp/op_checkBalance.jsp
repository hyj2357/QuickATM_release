...
<body>
  ...
  <div class="top">
   ...
   <div class="op_border">
      ...
      <div class="op_border_div"  onclick="window.location.href='http://139.129.24.81:10566/QuickATM/CheckAccountBalance'"   style="background-color:#FFFFFF;border-color:#FFFFFF #FF9900 #FFFFFF #FFFFFF;">
	    <span>
	     查询账户余额
		</span>
	  </div>
