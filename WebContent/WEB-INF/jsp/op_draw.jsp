  ...
  <div class="top">
   ...
   <div class="content">
      <div style="left: 20%;position: absolute;top:30%;">
          <form action="http://139.129.24.81:10566/QuickATM/DrawFromAccount" method="post">
   ...
   <div class="op_border">
      ...
      <div class="op_border_div"  onclick="window.location.href='http://139.129.24.81:10566/QuickATM/pfs_s?p=op_draw.jsp'" style="background-color:#FFFFFF;border-color:#FFFFFF #FF9900 #FFFFFF #FFFFFF;">
	    <span>
	     取款
		</span>
	  </div>
