  ...
  <div class="top">
   ...
   <div class="content">
      <div style="left: 25%;position: absolute;top:20%;">
          <form action="http://139.129.24.81:8082/QuickATM/TransferAccount" method="post">
   ...
   <div class="op_border">
      ...
      <div class="op_border_div"  onclick="window.location.href='http://139.129.24.81:8082/QuickATM/pfs_s?p=op_transfer.jsp'"   style="background-color:#FFFFFF;border-color:#FFFFFF #FF9900 #FFFFFF #FFFFFF;">
	    <span>
	      转账
		</span>
	  </div>
